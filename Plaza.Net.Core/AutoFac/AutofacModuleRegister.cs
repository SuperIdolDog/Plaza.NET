...
namespace Plaza.Net.Core.AutoFac
{
    public class AutofacModuleRegister : Autofac.Module
    {
        protected override void Load(ContainerBuilder builder)
        {
            ...
            var servicesDllFile = Path.Combine(basePath, "Plaza.Net.Services.dll");
            var repositoryDllFile = Path.Combine(basePath, "Plaza.Net.Repository.dll");
